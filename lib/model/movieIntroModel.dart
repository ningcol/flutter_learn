...
class MovieIntroModel{
  ...
  MovieIntroModel(this.count,this.start,this.total,this.subjects,this.title,);

  factory MovieIntroModel.fromJson(Map<String, dynamic> srcJson) => _$MovieIntroModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$MovieIntroModelToJson(this);
