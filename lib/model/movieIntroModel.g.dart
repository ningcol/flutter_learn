...
part of 'movieIntroModel.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MovieIntroModel _$MovieIntroModelFromJson(Map<String, dynamic> json) {
  return MovieIntroModel(
      json['count'] as int,
      json['start'] as int,
      json['total'] as int,
...
Map<String, dynamic> _$MovieIntroModelToJson(MovieIntroModel instance) =>
    <String, dynamic>{
